...
# main function to read in profiles csv file and scrape profiles
def main(fl):
    data=[]
    ...
    print("length or links: ",len(urls))
...
if __name__ == "__main__":
    ...
    if(len(sys.argv)<2):
        print("not enough arguments enetered, required format:\n python scrape_profiles.py <profile list csv>")
